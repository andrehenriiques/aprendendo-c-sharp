...
namespace bytebank_ATENDIMENTO.bytebank.Atendimento
{
    internal class ByteBankAtendimento
    {
        ...
        private List<ContaCorrente> _listaDeContas = new List<ContaCorrente>(){
            new ContaCorrente(95) {Saldo=100, Titular = new Cliente{Cpf = "123456", Nome = "Henrique" } },
            new ContaCorrente(95) {Saldo=200, Titular = new Cliente{Cpf = "456788", Nome = "Pedro" }},
            new ContaCorrente(94) {Saldo=60, Titular = new Cliente{Cpf = "890123", Nome = "Marisa" }}
        };
        ...
        private void PesquisarContas()
        {
            ...
            Console.WriteLine("===============================");
            Console.WriteLine("\n");
            Console.Write("Deseja pesquisar por (1) NUMERO DA CONTA ou (2) CPF TITULAR ou (2) N da Agencia ? ");
